...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.92/24 | 172.20.20.1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet53 | - | 192.168.110.35/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet53 | - | 192.168.110.37/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_spine3_Ethernet53 | - | 192.168.110.39/31 | default | 1550 | False | - | - |
...
!
interface Ethernet3
   description P2P_spine1_Ethernet53
   no shutdown
   mtu 1550
   no switchport
   ip address 192.168.110.35/31
!
interface Ethernet4
   description P2P_spine2_Ethernet53
   no shutdown
   mtu 1550
   no switchport
   ip address 192.168.110.37/31
!
interface Ethernet5
   description P2P_spine3_Ethernet53
   no shutdown
   mtu 1550
   no switchport
   ip address 192.168.110.39/31
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.101.92/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.102.92/32 |
...
| 192.168.110.34 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.110.36 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.110.38 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VLAN_1000 | 192.168.101.92:11000 | 11000:11000 | - | - | learned | 1000 |
| VLAN_1001 | 192.168.101.92:11001 | 11001:11001 | - | - | learned | 1001 |
| VLAN_1002 | 192.168.101.92:11002 | 11002:11002 | - | - | learned | 1002 |
| VLAN_1003 | 192.168.101.92:11003 | 11003:11003 | - | - | learned | 1003 |
| VLAN_1004 | 192.168.101.92:11004 | 11004:11004 | - | - | learned | 1004 |
| VLAN_1005 | 192.168.101.92:11005 | 11005:11005 | - | - | learned | 1005 |
| VLAN_1006 | 192.168.101.92:11006 | 11006:11006 | - | - | learned | 1006 |
| VRF_A | 192.168.101.92:10 | 10:10 | - | - | learned | 10,20,30,40,50,100,200,300,400,500 |
...
router bgp 65191
   ...
   neighbor 192.168.110.34 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.110.34 remote-as 65001
   neighbor 192.168.110.34 description spine1_Ethernet53
   neighbor 192.168.110.36 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.110.36 remote-as 65001
   neighbor 192.168.110.36 description spine2_Ethernet53
   neighbor 192.168.110.38 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.110.38 remote-as 65001
   neighbor 192.168.110.38 description spine3_Ethernet53
