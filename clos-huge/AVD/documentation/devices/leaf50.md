...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.60/24 | 172.20.20.1 |
...
| --------- | --------------- | ------------ | --------- |
| mlag25 | Vlan4094 | 10.255.252.96 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_leaf49_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet2 | MLAG_leaf49_Ethernet2 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet51 | - | 192.168.109.39/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet51 | - | 192.168.109.41/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_spine3_Ethernet51 | - | 192.168.109.43/31 | default | 1550 | False | - | - |
...
!
interface Ethernet1
   description MLAG_leaf49_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_leaf49_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description P2P_spine1_Ethernet51
   no shutdown
   mtu 1550
   no switchport
   ip address 192.168.109.39/31
!
interface Ethernet4
   description P2P_spine2_Ethernet51
   no shutdown
   mtu 1550
   no switchport
   ip address 192.168.109.41/31
!
interface Ethernet5
   description P2P_spine3_Ethernet51
   no shutdown
   mtu 1550
   no switchport
   ip address 192.168.109.43/31
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_leaf49_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1
   description MLAG_leaf49_Port-Channel1
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.101.50/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.102.49/32 |
...
| Vlan3009 |  VRF_A  |  10.255.251.97/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.251.97/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.252.97/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.251.96 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 192.168.109.38 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.109.40 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.109.42 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.251.96 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VLAN_1000 | 192.168.101.50:11000 | 11000:11000 | - | - | learned | 1000 |
| VLAN_1001 | 192.168.101.50:11001 | 11001:11001 | - | - | learned | 1001 |
| VLAN_1002 | 192.168.101.50:11002 | 11002:11002 | - | - | learned | 1002 |
| VLAN_1003 | 192.168.101.50:11003 | 11003:11003 | - | - | learned | 1003 |
| VLAN_1004 | 192.168.101.50:11004 | 11004:11004 | - | - | learned | 1004 |
| VLAN_1005 | 192.168.101.50:11005 | 11005:11005 | - | - | learned | 1005 |
| VLAN_1006 | 192.168.101.50:11006 | 11006:11006 | - | - | learned | 1006 |
| VRF_A | 192.168.101.50:10 | 10:10 | - | - | learned | 10,20,30,40,50,100,200,300,400,500 |
...
router bgp 65148
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65148
   neighbor MLAG-IPv4-UNDERLAY-PEER next-hop-self
   neighbor MLAG-IPv4-UNDERLAY-PEER description leaf49
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.255.251.96 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.251.96 description leaf49_Vlan4093
   ...
   neighbor 192.168.109.38 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.109.38 remote-as 65001
   neighbor 192.168.109.38 description spine1_Ethernet51
   neighbor 192.168.109.40 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.109.40 remote-as 65001
   neighbor 192.168.109.40 description spine2_Ethernet51
   neighbor 192.168.109.42 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.109.42 remote-as 65001
   neighbor 192.168.109.42 description spine3_Ethernet51
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan-aware-bundle VLAN_1000
      rd 192.168.101.50:11000
      route-target both 11000:11000
      redistribute learned
      vlan 1000
   !
   vlan-aware-bundle VLAN_1001
      rd 192.168.101.50:11001
      route-target both 11001:11001
      redistribute learned
      vlan 1001
   !
   vlan-aware-bundle VLAN_1002
      rd 192.168.101.50:11002
      route-target both 11002:11002
      redistribute learned
      vlan 1002
   !
   vlan-aware-bundle VLAN_1003
      rd 192.168.101.50:11003
      route-target both 11003:11003
      redistribute learned
      vlan 1003
   !
   vlan-aware-bundle VLAN_1004
      rd 192.168.101.50:11004
      route-target both 11004:11004
      redistribute learned
      vlan 1004
   !
   vlan-aware-bundle VLAN_1005
      rd 192.168.101.50:11005
      route-target both 11005:11005
      redistribute learned
      vlan 1005
   !
   vlan-aware-bundle VLAN_1006
      rd 192.168.101.50:11006
   ...
   vrf VRF_A
      ...
      router-id 192.168.101.50
      neighbor 10.255.251.96 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.96 description leaf49_Vlan3009
...
ip prefix-list PL-MLAG-PEER-VRFS
   seq 10 permit 10.255.251.96/31
```
