...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.18/24 | 172.20.20.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_leaf7_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet2 | MLAG_leaf7_Ethernet2 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet9 | - | 192.168.108.43/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet9 | - | 192.168.108.45/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_spine3_Ethernet9 | - | 192.168.108.47/31 | default | 1550 | False | - | - |
...
!
interface Ethernet1
   description MLAG_leaf7_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_leaf7_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description P2P_spine1_Ethernet9
   no shutdown
   mtu 1550
   no switchport
   ip address 192.168.108.43/31
!
interface Ethernet4
   description P2P_spine2_Ethernet9
   no shutdown
   mtu 1550
   no switchport
   ip address 192.168.108.45/31
!
interface Ethernet5
   description P2P_spine3_Ethernet9
   no shutdown
   mtu 1550
   no switchport
   ip address 192.168.108.47/31
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_leaf7_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1
   description MLAG_leaf7_Port-Channel1
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.101.8/32 |
...
| Vlan3009 |  VRF_A  |  10.255.251.13/31  |  -  |  -  |  -  |  -  |
...
| 192.168.108.42 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.108.44 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.108.46 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.251.12 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VLAN_1000 | 192.168.101.8:11000 | 11000:11000 | - | - | learned | 1000 |
| VLAN_1001 | 192.168.101.8:11001 | 11001:11001 | - | - | learned | 1001 |
| VLAN_1002 | 192.168.101.8:11002 | 11002:11002 | - | - | learned | 1002 |
| VLAN_1003 | 192.168.101.8:11003 | 11003:11003 | - | - | learned | 1003 |
| VLAN_1004 | 192.168.101.8:11004 | 11004:11004 | - | - | learned | 1004 |
| VLAN_1005 | 192.168.101.8:11005 | 11005:11005 | - | - | learned | 1005 |
| VLAN_1006 | 192.168.101.8:11006 | 11006:11006 | - | - | learned | 1006 |
| VRF_A | 192.168.101.8:10 | 10:10 | - | - | learned | 10,20,30,40,50,100,200,300,400,500 |
...
router bgp 65106
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description leaf7
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.255.251.12 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.251.12 description leaf7_Vlan4093
   ...
   neighbor 192.168.108.42 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.108.42 remote-as 65001
   neighbor 192.168.108.42 description spine1_Ethernet9
   neighbor 192.168.108.44 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.108.44 remote-as 65001
   neighbor 192.168.108.44 description spine2_Ethernet9
   neighbor 192.168.108.46 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.108.46 remote-as 65001
   neighbor 192.168.108.46 description spine3_Ethernet9
   ...
   vrf VRF_A
      ...
      router-id 192.168.101.8
      neighbor 10.255.251.12 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.12 description leaf7_Vlan3009
