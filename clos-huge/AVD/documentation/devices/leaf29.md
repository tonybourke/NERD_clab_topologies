...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.39/24 | 172.20.20.1 |
...
| --------- | --------------- | ------------ | --------- |
| mlag15 | Vlan4094 | 10.255.252.57 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_leaf30_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet2 | MLAG_leaf30_Ethernet2 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet30 | - | 192.168.108.169/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet30 | - | 192.168.108.171/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_spine3_Ethernet30 | - | 192.168.108.173/31 | default | 1550 | False | - | - |
...
!
interface Ethernet1
   description MLAG_leaf30_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_leaf30_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description P2P_spine1_Ethernet30
   no shutdown
   mtu 1550
   no switchport
   ip address 192.168.108.169/31
!
interface Ethernet4
   description P2P_spine2_Ethernet30
   no shutdown
   mtu 1550
   no switchport
   ip address 192.168.108.171/31
!
interface Ethernet5
   description P2P_spine3_Ethernet30
   no shutdown
   mtu 1550
   no switchport
   ip address 192.168.108.173/31
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_leaf30_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1
   description MLAG_leaf30_Port-Channel1
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.101.29/32 |
...
| Vlan3009 |  VRF_A  |  10.255.251.56/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.251.56/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.252.56/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.251.57 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 192.168.108.168 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.108.170 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.108.172 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.251.57 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VLAN_1000 | 192.168.101.29:11000 | 11000:11000 | - | - | learned | 1000 |
| VLAN_1001 | 192.168.101.29:11001 | 11001:11001 | - | - | learned | 1001 |
| VLAN_1002 | 192.168.101.29:11002 | 11002:11002 | - | - | learned | 1002 |
| VLAN_1003 | 192.168.101.29:11003 | 11003:11003 | - | - | learned | 1003 |
| VLAN_1004 | 192.168.101.29:11004 | 11004:11004 | - | - | learned | 1004 |
| VLAN_1005 | 192.168.101.29:11005 | 11005:11005 | - | - | learned | 1005 |
| VLAN_1006 | 192.168.101.29:11006 | 11006:11006 | - | - | learned | 1006 |
| VRF_A | 192.168.101.29:10 | 10:10 | - | - | learned | 10,20,30,40,50,100,200,300,400,500 |
...
router bgp 65128
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description leaf30
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.255.251.57 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.251.57 description leaf30_Vlan4093
   ...
   neighbor 192.168.108.168 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.108.168 remote-as 65001
   neighbor 192.168.108.168 description spine1_Ethernet30
   neighbor 192.168.108.170 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.108.170 remote-as 65001
   neighbor 192.168.108.170 description spine2_Ethernet30
   neighbor 192.168.108.172 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.108.172 remote-as 65001
   neighbor 192.168.108.172 description spine3_Ethernet30
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan-aware-bundle VLAN_1000
      rd 192.168.101.29:11000
      route-target both 11000:11000
      redistribute learned
      vlan 1000
   !
   vlan-aware-bundle VLAN_1001
      rd 192.168.101.29:11001
      route-target both 11001:11001
      redistribute learned
      vlan 1001
   !
   vlan-aware-bundle VLAN_1002
      rd 192.168.101.29:11002
      route-target both 11002:11002
      redistribute learned
      vlan 1002
   !
   vlan-aware-bundle VLAN_1003
      rd 192.168.101.29:11003
      route-target both 11003:11003
      redistribute learned
      vlan 1003
   !
   vlan-aware-bundle VLAN_1004
      rd 192.168.101.29:11004
      route-target both 11004:11004
      redistribute learned
      vlan 1004
   !
   vlan-aware-bundle VLAN_1005
      rd 192.168.101.29:11005
      route-target both 11005:11005
      redistribute learned
      vlan 1005
   !
   vlan-aware-bundle VLAN_1006
      rd 192.168.101.29:11006
   ...
   vrf VRF_A
      ...
      router-id 192.168.101.29
      neighbor 10.255.251.57 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.57 description leaf30_Vlan3009
