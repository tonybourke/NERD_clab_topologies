...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.50/24 | 172.20.20.1 |
...
| --------- | --------------- | ------------ | --------- |
| mlag20 | Vlan4094 | 10.255.252.76 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_leaf39_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet2 | MLAG_leaf39_Ethernet2 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet41 | - | 192.168.108.235/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet41 | - | 192.168.108.237/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_spine3_Ethernet41 | - | 192.168.108.239/31 | default | 1550 | False | - | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_leaf39_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.101.40/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.102.39/32 |
...
| Vlan3009 |  VRF_A  |  10.255.251.77/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.251.77/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.252.77/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.251.76 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 192.168.108.234 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.108.236 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.108.238 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.251.76 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VLAN_1000 | 192.168.101.40:11000 | 11000:11000 | - | - | learned | 1000 |
| VLAN_1001 | 192.168.101.40:11001 | 11001:11001 | - | - | learned | 1001 |
| VLAN_1002 | 192.168.101.40:11002 | 11002:11002 | - | - | learned | 1002 |
| VLAN_1003 | 192.168.101.40:11003 | 11003:11003 | - | - | learned | 1003 |
| VLAN_1004 | 192.168.101.40:11004 | 11004:11004 | - | - | learned | 1004 |
| VLAN_1005 | 192.168.101.40:11005 | 11005:11005 | - | - | learned | 1005 |
| VLAN_1006 | 192.168.101.40:11006 | 11006:11006 | - | - | learned | 1006 |
| VRF_A | 192.168.101.40:10 | 10:10 | - | - | learned | 10,20,30,40,50,100,200,300,400,500 |
...
router bgp 65138
   ...
   neighbor 10.255.251.76 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.251.76 description leaf39_Vlan4093
   ...
   neighbor 192.168.108.234 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.108.234 remote-as 65001
   neighbor 192.168.108.234 description spine1_Ethernet41
   neighbor 192.168.108.236 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.108.236 remote-as 65001
   neighbor 192.168.108.236 description spine2_Ethernet41
   neighbor 192.168.108.238 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.108.238 remote-as 65001
   neighbor 192.168.108.238 description spine3_Ethernet41
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan-aware-bundle VLAN_1000
      rd 192.168.101.40:11000
      route-target both 11000:11000
      redistribute learned
      vlan 1000
   !
   vlan-aware-bundle VLAN_1001
      rd 192.168.101.40:11001
      route-target both 11001:11001
      redistribute learned
      vlan 1001
   !
   vlan-aware-bundle VLAN_1002
      rd 192.168.101.40:11002
      route-target both 11002:11002
      redistribute learned
      vlan 1002
   !
   vlan-aware-bundle VLAN_1003
      rd 192.168.101.40:11003
      route-target both 11003:11003
      redistribute learned
      vlan 1003
   !
   vlan-aware-bundle VLAN_1004
      rd 192.168.101.40:11004
      route-target both 11004:11004
      redistribute learned
      vlan 1004
   !
   vlan-aware-bundle VLAN_1005
      rd 192.168.101.40:11005
      route-target both 11005:11005
      redistribute learned
      vlan 1005
   !
   vlan-aware-bundle VLAN_1006
      rd 192.168.101.40:11006
   ...
   vrf VRF_A
      ...
      router-id 192.168.101.40
      neighbor 10.255.251.76 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.76 description leaf39_Vlan3009
