...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet52 | - | 192.168.110.29/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet52 | - | 192.168.110.31/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_spine3_Ethernet52 | - | 192.168.110.33/31 | default | 1550 | False | - | - |
...
!
interface Ethernet3
   description P2P_spine1_Ethernet52
   no shutdown
   mtu 1550
   no switchport
...
!
interface Ethernet4
   description P2P_spine2_Ethernet52
   no shutdown
   mtu 1550
   no switchport
...
!
interface Ethernet5
   description P2P_spine3_Ethernet52
   no shutdown
   mtu 1550
   no switchport
...
| 192.168.110.28 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.110.30 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.110.32 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| VRF_A | 192.168.101.91:10 | 10:10 | - | - | learned | 10,20,30,40,50,100,200,300,400,500 |
...
router bgp 65190
   ...
   neighbor 192.168.110.28 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.110.28 remote-as 65001
   neighbor 192.168.110.28 description spine1_Ethernet52
   neighbor 192.168.110.30 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.110.30 remote-as 65001
   neighbor 192.168.110.30 description spine2_Ethernet52
   neighbor 192.168.110.32 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.110.32 remote-as 65001
   neighbor 192.168.110.32 description spine3_Ethernet52
