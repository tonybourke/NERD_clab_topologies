...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.22/24 | 172.20.20.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_leaf11_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet2 | MLAG_leaf11_Ethernet2 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet13 | - | 192.168.108.67/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet13 | - | 192.168.108.69/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_spine3_Ethernet13 | - | 192.168.108.71/31 | default | 1550 | False | - | - |
...
!
interface Ethernet1
   description MLAG_leaf11_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_leaf11_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description P2P_spine1_Ethernet13
   no shutdown
   mtu 1550
   no switchport
...
!
interface Ethernet4
   description P2P_spine2_Ethernet13
   no shutdown
   mtu 1550
   no switchport
...
!
interface Ethernet5
   description P2P_spine3_Ethernet13
   no shutdown
   mtu 1550
   no switchport
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_leaf11_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1
   description MLAG_leaf11_Port-Channel1
   no shutdown
...
| 192.168.108.66 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.108.68 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.108.70 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VLAN_1000 | 192.168.101.12:11000 | 11000:11000 | - | - | learned | 1000 |
| VLAN_1001 | 192.168.101.12:11001 | 11001:11001 | - | - | learned | 1001 |
| VLAN_1002 | 192.168.101.12:11002 | 11002:11002 | - | - | learned | 1002 |
| VLAN_1003 | 192.168.101.12:11003 | 11003:11003 | - | - | learned | 1003 |
| VLAN_1004 | 192.168.101.12:11004 | 11004:11004 | - | - | learned | 1004 |
| VLAN_1005 | 192.168.101.12:11005 | 11005:11005 | - | - | learned | 1005 |
| VLAN_1006 | 192.168.101.12:11006 | 11006:11006 | - | - | learned | 1006 |
| VRF_A | 192.168.101.12:10 | 10:10 | - | - | learned | 10,20,30,40,50,100,200,300,400,500 |
...
router bgp 65110
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description leaf11
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.255.251.20 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.251.20 description leaf11_Vlan4093
   ...
   vrf VRF_A
      ...
      router-id 192.168.101.12
      neighbor 10.255.251.20 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.20 description leaf11_Vlan3009
