...
| --------- | --------------- | ------------ | --------- |
| mlag23 | Vlan4094 | 10.255.252.88 | Port-Channel1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet47 | - | 192.168.109.15/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet47 | - | 192.168.109.17/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_spine3_Ethernet47 | - | 192.168.109.19/31 | default | 1550 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.101.46/32 |
...
| Vlan3009 |  VRF_A  |  10.255.251.89/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.251.89/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.252.89/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.251.88 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 192.168.109.14 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.109.16 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.109.18 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.251.88 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VLAN_1000 | 192.168.101.46:11000 | 11000:11000 | - | - | learned | 1000 |
| VLAN_1001 | 192.168.101.46:11001 | 11001:11001 | - | - | learned | 1001 |
| VLAN_1002 | 192.168.101.46:11002 | 11002:11002 | - | - | learned | 1002 |
| VLAN_1003 | 192.168.101.46:11003 | 11003:11003 | - | - | learned | 1003 |
| VLAN_1004 | 192.168.101.46:11004 | 11004:11004 | - | - | learned | 1004 |
| VLAN_1005 | 192.168.101.46:11005 | 11005:11005 | - | - | learned | 1005 |
| VLAN_1006 | 192.168.101.46:11006 | 11006:11006 | - | - | learned | 1006 |
| VRF_A | 192.168.101.46:10 | 10:10 | - | - | learned | 10,20,30,40,50,100,200,300,400,500 |
...
router bgp 65144
   ...
   neighbor 10.255.251.88 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.251.88 description leaf45_Vlan4093
   ...
   neighbor 192.168.109.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.109.14 remote-as 65001
   neighbor 192.168.109.14 description spine1_Ethernet47
   neighbor 192.168.109.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.109.16 remote-as 65001
   neighbor 192.168.109.16 description spine2_Ethernet47
   neighbor 192.168.109.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.109.18 remote-as 65001
   neighbor 192.168.109.18 description spine3_Ethernet47
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan-aware-bundle VLAN_1000
      rd 192.168.101.46:11000
      route-target both 11000:11000
      redistribute learned
      vlan 1000
   !
   vlan-aware-bundle VLAN_1001
      rd 192.168.101.46:11001
      route-target both 11001:11001
      redistribute learned
      vlan 1001
   !
   vlan-aware-bundle VLAN_1002
      rd 192.168.101.46:11002
      route-target both 11002:11002
      redistribute learned
      vlan 1002
   !
   vlan-aware-bundle VLAN_1003
      rd 192.168.101.46:11003
      route-target both 11003:11003
      redistribute learned
      vlan 1003
   !
   vlan-aware-bundle VLAN_1004
      rd 192.168.101.46:11004
      route-target both 11004:11004
      redistribute learned
      vlan 1004
   !
   vlan-aware-bundle VLAN_1005
      rd 192.168.101.46:11005
      route-target both 11005:11005
      redistribute learned
      vlan 1005
   !
   vlan-aware-bundle VLAN_1006
      rd 192.168.101.46:11006
   ...
   vrf VRF_A
      ...
      router-id 192.168.101.46
      neighbor 10.255.251.88 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.88 description leaf45_Vlan3009
