...
| Ethernet7 | SERVER_host1_e2 | *access | *10 | *- | *- | 7 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet3 | - | 192.168.108.7/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet3 | - | 192.168.108.9/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_spine3_Ethernet3 | - | 192.168.108.11/31 | default | 1550 | False | - | - |
...
interface Ethernet5
   ...
   mtu 1550
   no switchport
   ip address 192.168.108.11/31
!
interface Ethernet7
   description SERVER_host1_e2
   no shutdown
...
| Port-Channel7 | PortChanne1 | access | 10 | - | - | - | - | 7 | - |
...
| 192.168.108.6 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.108.8 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.108.10 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VLAN_1000 | 192.168.101.2:11000 | 11000:11000 | - | - | learned | 1000 |
| VLAN_1001 | 192.168.101.2:11001 | 11001:11001 | - | - | learned | 1001 |
| VLAN_1002 | 192.168.101.2:11002 | 11002:11002 | - | - | learned | 1002 |
| VLAN_1003 | 192.168.101.2:11003 | 11003:11003 | - | - | learned | 1003 |
| VLAN_1004 | 192.168.101.2:11004 | 11004:11004 | - | - | learned | 1004 |
| VLAN_1005 | 192.168.101.2:11005 | 11005:11005 | - | - | learned | 1005 |
| VLAN_1006 | 192.168.101.2:11006 | 11006:11006 | - | - | learned | 1006 |
| VRF_A | 192.168.101.2:10 | 10:10 | - | - | learned | 10,20,30,40,50,100,200,300,400,500 |
...
router bgp 65100
   ...
   neighbor 192.168.108.6 description spine1_Ethernet3
   neighbor 192.168.108.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.108.8 remote-as 65001
   neighbor 192.168.108.8 description spine2_Ethernet3
   neighbor 192.168.108.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.108.10 remote-as 65001
   neighbor 192.168.108.10 description spine3_Ethernet3
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan-aware-bundle VLAN_1000
      rd 192.168.101.2:11000
      route-target both 11000:11000
      redistribute learned
      vlan 1000
   !
   vlan-aware-bundle VLAN_1001
      rd 192.168.101.2:11001
      route-target both 11001:11001
      redistribute learned
      vlan 1001
   !
   vlan-aware-bundle VLAN_1002
      rd 192.168.101.2:11002
      route-target both 11002:11002
      redistribute learned
      vlan 1002
   !
   vlan-aware-bundle VLAN_1003
      rd 192.168.101.2:11003
      route-target both 11003:11003
      redistribute learned
      vlan 1003
   !
   vlan-aware-bundle VLAN_1004
      rd 192.168.101.2:11004
      route-target both 11004:11004
      redistribute learned
      vlan 1004
   !
   vlan-aware-bundle VLAN_1005
      rd 192.168.101.2:11005
      route-target both 11005:11005
      redistribute learned
      vlan 1005
   !
   vlan-aware-bundle VLAN_1006
      rd 192.168.101.2:11006
