...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.24/24 | 172.20.20.1 |
...
| --------- | --------------- | ------------ | --------- |
| mlag7 | Vlan4094 | 10.255.252.24 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_leaf13_Ethernet1 | *trunk | *- | *- | *MLAG | 1 |
| Ethernet2 | MLAG_leaf13_Ethernet2 | *trunk | *- | *- | *MLAG | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet15 | - | 192.168.108.79/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet15 | - | 192.168.108.81/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_spine3_Ethernet15 | - | 192.168.108.83/31 | default | 1550 | False | - | - |
...
!
interface Ethernet1
   description MLAG_leaf13_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_leaf13_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description P2P_spine1_Ethernet15
   no shutdown
   mtu 1550
   no switchport
   ip address 192.168.108.79/31
!
interface Ethernet4
   description P2P_spine2_Ethernet15
   no shutdown
   mtu 1550
   no switchport
   ip address 192.168.108.81/31
!
interface Ethernet5
   description P2P_spine3_Ethernet15
   no shutdown
   mtu 1550
   no switchport
   ip address 192.168.108.83/31
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_leaf13_Port-Channel1 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1
   description MLAG_leaf13_Port-Channel1
   no shutdown
...
| Vlan3009 |  VRF_A  |  10.255.251.25/31  |  -  |  -  |  -  |  -  |
...
| 192.168.108.78 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.108.80 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.108.82 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.251.24 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VLAN_1000 | 192.168.101.14:11000 | 11000:11000 | - | - | learned | 1000 |
| VLAN_1001 | 192.168.101.14:11001 | 11001:11001 | - | - | learned | 1001 |
| VLAN_1002 | 192.168.101.14:11002 | 11002:11002 | - | - | learned | 1002 |
| VLAN_1003 | 192.168.101.14:11003 | 11003:11003 | - | - | learned | 1003 |
| VLAN_1004 | 192.168.101.14:11004 | 11004:11004 | - | - | learned | 1004 |
| VLAN_1005 | 192.168.101.14:11005 | 11005:11005 | - | - | learned | 1005 |
| VLAN_1006 | 192.168.101.14:11006 | 11006:11006 | - | - | learned | 1006 |
| VRF_A | 192.168.101.14:10 | 10:10 | - | - | learned | 10,20,30,40,50,100,200,300,400,500 |
...
router bgp 65112
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description leaf13
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.255.251.24 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.251.24 description leaf13_Vlan4093
   ...
   neighbor 192.168.108.78 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.108.78 remote-as 65001
   neighbor 192.168.108.78 description spine1_Ethernet15
   neighbor 192.168.108.80 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.108.80 remote-as 65001
   neighbor 192.168.108.80 description spine2_Ethernet15
   neighbor 192.168.108.82 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.108.82 remote-as 65001
   neighbor 192.168.108.82 description spine3_Ethernet15
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan-aware-bundle VLAN_1000
      rd 192.168.101.14:11000
      route-target both 11000:11000
      redistribute learned
      vlan 1000
   !
   vlan-aware-bundle VLAN_1001
      rd 192.168.101.14:11001
      route-target both 11001:11001
      redistribute learned
      vlan 1001
   !
   vlan-aware-bundle VLAN_1002
      rd 192.168.101.14:11002
      route-target both 11002:11002
      redistribute learned
      vlan 1002
   !
   vlan-aware-bundle VLAN_1003
      rd 192.168.101.14:11003
      route-target both 11003:11003
      redistribute learned
      vlan 1003
   !
   vlan-aware-bundle VLAN_1004
      rd 192.168.101.14:11004
      route-target both 11004:11004
      redistribute learned
      vlan 1004
   !
   vlan-aware-bundle VLAN_1005
      rd 192.168.101.14:11005
      route-target both 11005:11005
      redistribute learned
      vlan 1005
   !
   vlan-aware-bundle VLAN_1006
      rd 192.168.101.14:11006
   ...
   vrf VRF_A
      ...
      router-id 192.168.101.14
      neighbor 10.255.251.24 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.24 description leaf13_Vlan3009
